  ...
  return (
    <div className="mt-4 md:mt-10 flex gap-0">
      ...
      >
        ...
        <span className="hidden sm:block">Bài viết</span>
      </Link>
      <Link
      ...
      >
        ...
        <span className="hidden sm:block">Giới thiệu</span>
      </Link>
      <Link
        href={`/profile/${userId}/follow`}
        className={active === "follow" ? activeTabClasses : tabClasses}
      >
        <svg
          xmlns="http://www.w3.org/2000/svg"
          fill="none"
